...
def selection_sort(input_array)
  ...
  input_array[starting_index], input_array[lowest_value_index] =
  input_array[lowest_value_index], input_array[starting_index]
...
def insertion_sort(input_array)
  ...
  for i in 1..size do
    ...
    while previous >= 0
      if input_array[previous] > temp_value
        input_array[previous +1] = input_array[previous]
        previous -= 1
      else
        break
      end
    ...
    input_array[previous + 1] = temp_value
  end
